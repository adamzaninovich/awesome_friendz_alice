defmodule Alice.Handlers.Random do
  ...
  @doc false
  def flowery_bullshit_chance(conn) do
    chance_reply(conn, 0.5, ["http://i.imgur.com/ioLp3DW.jpg",
  ...
  def grapes(conn), do: chance_reply(conn, 0.01, "http://i.imgur.com/v4y3BLl.gif", ":grapes:")
